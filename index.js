...
// ANSWER:   console.log(arry.splice(0,2))
// O(n)
...
// Starting Code:
function squareEveryDigit(number) { // here we created the function called squareEveryDigit , number as parameter that accepts an int as an argument
   let numStr = number + ""; // here converting the our number in to string ,for split the number.
   //assign our sting to a variable called numStr
  let total = "";
//
  for(let i in numStr){
